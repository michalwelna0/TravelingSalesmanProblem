...
int main(){
    /*
     ...
     auto tp1 = check_paths_and_choose_tuple(mat3);
     result.push_back(tp1);

     double LB2 = reduce(mat3,LB);
     //std::cout<<LB2;
     ...
     auto tp2 = check_paths_and_choose_tuple(mat3);
     result.push_back(tp2);


     double LB3 = reduce(mat3,LB2);
     auto tp3 = check_paths_and_choose_tuple(mat3);
    ...
    double LB4 = reduce(mat3,LB3);
    auto tp4 = check_paths_and_choose_tuple(mat3);
    ...
    double LB5 = reduce(mat3,LB4);
    auto tp5 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp5);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB6 = reduce(mat3,LB5);
    auto tp6 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp6);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB7 = reduce(mat3,LB6);
    auto tp7 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp7);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB8 = reduce(mat3,LB7);
    auto tp8 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp8);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB9 = reduce(mat3,LB8);
    auto tp9 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp9);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB10 = reduce(mat3,LB9);
    auto tp10 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp10);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB11 = reduce(mat3,LB10);
    auto tp11 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp11);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB12 = reduce(mat3,LB11);
    auto tp12 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp12);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB13 = reduce(mat3,LB12);

    auto tp13 = check_paths_and_choose_tuple(mat3);
    result.push_back(tp13);
    for(auto e :mat3){
        for(auto w: e){
            std::cout<< w << '\t';
    ...
    double LB14 = reduce(mat3,LB13);
    auto vec_add = find_last_two_points(mat3);
    result.insert(result.end(),vec_add.begin(),vec_add.end());
    auto result1 = sort_tuples_and_give_result(result);
    for (auto e : result1){
        std::cout<< e <<' ';
    }
